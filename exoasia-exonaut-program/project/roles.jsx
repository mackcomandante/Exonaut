    ...
    <div className="enter">
      <div className="section-head">
        <div>
          ...
          <div className="t-body" style={{ marginTop: 6 }}>Welcome, Dr. Oyelaran. {myExonauts.length} Exonauts under your command.</div>
        </div>
      ...
      <div className="card-panel" style={{ marginTop: 18 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 40px 1fr 40px 1fr', gap: 14, alignItems: 'center' }}>
          ...
          <ChainNode role="MANAGER" name="Dr. Nadia Oyelaran" sub={track.short + ' · You'} accent="platinum" active />
          <i className="fa-solid fa-arrow-left" style={{ color: 'var(--off-white-40)', textAlign: 'center' }} />
