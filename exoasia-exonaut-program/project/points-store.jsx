...
(function () {
  ...
  function toEntry(row) {
    return {
      ...
      pillar: row.pillar === 'project' ? 'missions' : (row.pillar || 'missions'),
  ...
  function fallbackFromApprovedSubs() {
    ...
    return subs
      ...
      .map(s => ({
        ...
        note: s.missionTitle || 'Approved track task',
        awardedBy: null,
  ...
  async function award(entry) {
    ...
    const row = {
      ...
      pillar: entry.pillar === 'project' ? 'missions' : (entry.pillar || 'missions'),
