...
function App() {
  ...
  if (authStage === 'onboarding') {
    return <Onboarding onComplete={() => { setAuthStage('app'); setRoute('dashboard'); }} />;
  }
  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-user" style={{ cursor: 'pointer' }} onClick={() => onNavigate('lead-profile')} title="Open my profile">
        <AvatarWithRing name="Dr. Nadia Oyelaran" size={36} tier="corps" />
        <div className="sidebar-user-info">
          <div className="sidebar-user-name">Dr. Nadia Oyelaran</div>
