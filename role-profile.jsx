...
const ROLE_PROFILE_DEFAULTS = {
  ...
  commander: {
    ...
    bio: 'Founder of Exoasia Innovation Hub. Builds the program, sets the standard, keeps the bar high. 20+ years in venture + advisory across SEA and MENA.',
    email: 'mack@exoasia.co',
    phone: '+65 8122 0077',
    location: 'Singapore',
    expertise: 'Program Leadership · Venture Strategy · Partnerships',
    roleLabel: 'DIRECTOR · FOUNDER',
    roleColor: 'amber',
